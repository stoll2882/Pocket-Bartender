...
public class BrowseDrinksAPI {
    private String apiKey = "9973533";
    static final String TAG = "DrinkAPITag";

    BrowseDrinksFragment browseDrinksFragment;

    // Parameters: mainActivity
    // Return: none
    // PlacesAPI EVC
    public BrowseDrinksAPI(BrowseDrinksFragment browseDrinksFragment) {
        this.browseDrinksFragment = browseDrinksFragment;
    }

    // Parameters: location, keyword
    // Return: none
    // starts async task to fetch nearby places
    public void fetchDrinks() throws MalformedURLException {
        String drinksURL = "https://www.thecocktaildb.com/api/json/v2/9973533/randomSelection.php";
    ...
    class FetchDrinksAsyncTask extends AsyncTask<String, Void, List<Drink>> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            ProgressBar progressBar = browseDrinksFragment.getActivity().findViewById(R.id.progressBar);
        ...
        protected void onPostExecute(List<Drink> drinks) {
            ...
            browseDrinksFragment.receivedDrinks(drinks);
            ProgressBar progressBar = browseDrinksFragment.getActivity().findViewById(R.id.progressBar);
